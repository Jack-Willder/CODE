...
class MyGUI:
    def __init__(self):
        ...
        self.btn1 = Button(self.root, text="click Me!", font=("Arial", 10), activebackground="Black", activeforeground="White")
        self.btn1.grid(row=1, column=0, columnspan=2, sticky=E + W, padx=5, pady=5)
        self.btn2 = Button(self.root, text="Exit", font=("Arial", 10), activebackground="Black", activeforeground="White", command=self.root.quit)
        ...
        while True:
            ...
            try:
                ...
                if speed > 130:
                    ...
                    bgcol = "#d62828"
                    playsound('Soft Notification.mp3')
                elif 60 <= speed <= 79:
                    bgcol = "#fcbf49"
                    playsound('Soft Notification.mp3')
                elif speed < 60:
