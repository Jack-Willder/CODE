...
content = content.find_all("p", {"class": "has-text-align-center"})
countvar = 0
for a in content:
    ...
    if a is not None:
        # countvar += 1
        # print("URL - ", a['href'])
        if "%201080p%20" in a['href']:
            countvar += 1
            web_url = a['href']
            print("URL - ", a['href'])
            system("\"C:/Program Files/BraveSoftware/Brave-Browser/Application/brave.exe\" {}".format(web_url))

# "C:\Program Files\BraveSoftware\Brave-Browser\Application\brave.exe"
print("count - ", countvar)
